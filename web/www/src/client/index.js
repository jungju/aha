...
/**
 * AHA온 초기화
 * request: SystemController_InitAhaOn
 * url: SystemController_InitAhaOnURL
 * method: SystemController_InitAhaOn_TYPE
 * raw_url: SystemController_InitAhaOn_RAW_URL
 */
export const SystemController_InitAhaOn = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
...
export const SystemController_InitAhaOn_RAW_URL = function() {
  return '/system/init'
}
export const SystemController_InitAhaOn_TYPE = function() {
  return 'get'
}
export const SystemController_InitAhaOnURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/system/init'
  if (parameters.$queryParameters) {
